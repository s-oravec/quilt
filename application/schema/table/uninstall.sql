prompt .. Dropping table QUILT_REPORTED_OBJECT
DROP TABLE quilt_reported_object CASCADE CONSTRAINTS PURGE;

prompt .. Dropping table QUILT_LOG
DROP TABLE quilt_log CASCADE CONSTRAINTS PURGE;

prompt .. Dropping table QUILT_REPORT_LINE
DROP TABLE quilt_report_line CASCADE CONSTRAINTS PURGE;
